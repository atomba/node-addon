...
#define SWIGTYPE_p_nodetest swig_types[1]
...
#define SWIGV8_INIT nodetest_initialize


SWIGV8_ClientData _exports_nodetest_clientData;


static SwigV8ReturnValue _wrap_new_nodetest(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Object> self = args.Holder();
  nodetest *result;
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_nodetest.");
  result = (nodetest *)new nodetest();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_nodetest, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
#if (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_nodetest(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_nodetest(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_nodetest(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#else
      static void _wrap_delete_nodetest(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#endif
        
        if(proxy->swigCMemOwn && proxy->swigCObject) {
          nodetest * arg1 = (nodetest *)proxy->swigCObject;
          delete arg1;
        }
        delete proxy;
...
static SwigV8ReturnValue _wrap_nodetest_testCharArray(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  nodetest *arg1 = (nodetest *) 0 ;
  int arg2 ;
  char **arg3 = (char **) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_nodetest_testCharArray.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_nodetest, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "nodetest_testCharArray" "', argument " "1"" of type '" "nodetest *""'"); 
  }
  arg1 = (nodetest *)(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "nodetest_testCharArray" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  res3 = SWIG_ConvertPtr(args[1], &argp3,SWIGTYPE_p_p_char, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "nodetest_testCharArray" "', argument " "3"" of type '" "char **""'"); 
  }
  arg3 = (char **)(argp3);
  (arg1)->testCharArray(arg2,arg3);
...
static swig_type_info _swigt__p_nodetest = {"_p_nodetest", "nodetest *|p_nodetest", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_nodetest[] = {  {&_swigt__p_nodetest, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_nodetest, Type: p_nodetest, Dtor: _wrap_delete_nodetest */
v8::Handle<v8::FunctionTemplate> _exports_nodetest_class = SWIGV8_CreateClassTemplate("_exports_nodetest");
SWIGV8_SET_CLASS_TEMPL(_exports_nodetest_clientData.class_templ, _exports_nodetest_class);
_exports_nodetest_clientData.dtor = _wrap_delete_nodetest;
if (SWIGTYPE_p_nodetest->clientdata == 0) {
  SWIGTYPE_p_nodetest->clientdata = &_exports_nodetest_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_nodetest_class, "testCharArray", _wrap_nodetest_testCharArray);
  ...
  /* class instances */
  /* Class: nodetest (_exports_nodetest) */
v8::Handle<v8::FunctionTemplate> _exports_nodetest_class_0 = SWIGV8_CreateClassTemplate("nodetest");
_exports_nodetest_class_0->SetCallHandler(_wrap_new_nodetest);
_exports_nodetest_class_0->Inherit(_exports_nodetest_class);
_exports_nodetest_class_0->SetHiddenPrototype(true);
v8::Handle<v8::Object> _exports_nodetest_obj = _exports_nodetest_class_0->GetFunction();
  ...
  /* register classes */
  exports_obj->Set(SWIGV8_SYMBOL_NEW("nodetest"), _exports_nodetest_obj);
...
NODE_MODULE(nodetest, nodetest_initialize)
#endif
